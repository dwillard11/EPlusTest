...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      ztree:       [   'libs/jquery/ztree/jquery.ztree.all.min.js',
                        'libs/jquery/ztree/zTreeStyle.css'],
  ...
  .constant('MODULE_CONFIG', [
      ...
      },
      {
          name: 'ui.tree',
          files: [
              'libs/angular/angular-ui-tree/dist/angular-ui-tree.min.js',
              'libs/angular/angular-ui-tree/dist/angular-ui-tree.min.css'
          ]
      },
      {
      ...
      {
          name: 'darthwade.loading',
          files: [
              'libs/angular/angular-loading/angular-loading.css',
              'libs/angular/angular-loading/angular-loading.min.js',
              'libs/angular/angular-loading/spin.js'
          ]
      },
      {
          name: 'textAngular',
