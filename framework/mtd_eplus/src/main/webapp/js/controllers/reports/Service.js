app.controller('servicereportctrl', ['$scope', '$timeout', '$http', '$state', 'toaster', '$localStorage', 'valutils','$filter',
    function ($scope, $timeout, $http, $state, toaster, $localStorage, valutils,$filter) {
        ...
        $scope.getData = function () {
            ...
            $http({
                method: 'GET',
                url: "report/reportManager/getServiceReporting.do",
        ...
        function coverttoexportdataformat(dataCollection) {
            var dataarray = [];
            var keyarray = ["Consignee", "Pieces","Weight", "Charge WT", "Units", "Total Cost","Amount Invoiced","Currency","Service"];
        ...
        $scope.exportcsv = function (exportOption) {
            ...
            $scope.csvfilename = 'Service Reporting.csv';
        ...
        $scope.exportpdf = function (exportOption) {
            ...
            pdfMake.createPdf(docDefinition1).download('Service Reporting.pdf');
        }
