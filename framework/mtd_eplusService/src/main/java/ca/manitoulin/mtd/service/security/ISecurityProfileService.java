...
public interface ISecurityProfileService {
	...
	/**
	 * Save user latest action
	 * @param uId
	 */
	void saveUserAction(String uId);
	
	/**
	 * Retrieve number of online users for each role
	 * @param deparmentId 
	 * @return
	 */
	List<Role> retrieveNumberOfOnlineUsers(Integer deparmentId);
